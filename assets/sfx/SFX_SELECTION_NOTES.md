...
- `assets/sfx/ui_hover/`
  - 按钮悬停 / 轻选择候选
- `assets/sfx/event_roulette/`
  - 事件轮盘 tick 候选
- `assets/sfx/event_result/`
  - 事件结果正负反馈候选
- `assets/sfx/chamber/`
  - 控制舱过门 / 落点类候选
- `assets/sfx/turret_destroy/`
  - 炮塔摧毁候选
- `assets/sfx/timer_warning/`
  - 限时模式警告候选
- `assets/sfx/results/`
  - 胜利 / 结算候选
- `assets/sfx/music/`
...
- 后续如果要缩小包体，可以在每个子目录里保留 1 到 2 个最终版，其余回退到 `art_reference/asset_gap_downloads/`。
