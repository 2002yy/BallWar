...
- `README_v2_1_8_decor_and_chamber_state.md`
  - decor-layer event model, chamber-state extraction
- `README_v2_1_4_restore_interfaces_and_perf_cleanup.md`
  - stable structural baseline for restore and orchestration cleanup
- `README_v2_0_7_start_menu_scene.md`
  - start-menu scene migration
- `README_v1_9_37_perf_benchmark.md`
  - performance benchmark milestone

## Naming rule

- `README_v*.md`
  - one file per historical stage or milestone
